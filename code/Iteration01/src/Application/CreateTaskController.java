...
public class CreateTaskController {
   ...
   *
   * @param projectName Domain.Project name corresponding to the project to which both tasks belong, given by the user
   * @param taskName Domain.Task name of the replacement task, given by the user
   * @param description Domain.Task description of the replacement task, given by the user
   ...
   * @param replaces Domain.Task name of the task that the new task would replace, given by the user

...
public class CreateTaskUI {
    ...
    public CreateTaskUI(Session session, TaskManSystem taskManSystem, UserManager user) {
        this.controller = new CreateTaskController(session, this, taskManSystem, user);
    }
    ...
    public void createTaskForm() {
        ...
        if (answer.equals("y")) {
            ...
            controller.replaceTask(projectName, taskName, description, durationHour, durationMinutes, deviation, replaces);
        }
        else {
            ...
            controller.createTask(projectName, taskName, description, durationHour, durationMinutes, deviation, developer, previousTasks);
        }
    }

    public void messageTaskCreation(String projectName, String taskName){
        System.out.println("Task " + taskName + " is successfully created in Project " + projectName);
    }

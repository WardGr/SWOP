...
public class Project {
  ...
  public String toString() {
    ...
    projectString.append("Domain.Project Name:  " + getName() + '\n' +
                         "Description:   " + getDescription() + '\n' +
                         "Creation Domain.Time: " + getCreationTime() + '\n' +
                         "Due Domain.Time:      " + getDueTime() + '\n' +
                         "Domain.Status:        " + getStatus() + '\n'
    );
  ...
  /**
   * @return Domain.Status of the current project, finished if all tasks are finished, ongoing otherwise
   */
   ...
   * @param selectedTaskName Domain.User input, may correspond to a task name
   ...
   * @param user Domain.User to be assigned to this task
   ...
   * @param endTime Domain.Time at which the task was/will be finished/failed
   * @param systemTime Current system-time
   * @param currentUser Domain.User currently logged in

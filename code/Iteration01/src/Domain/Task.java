...
public class Task {
   ...
   * @param user Domain.User assigned to this task
   */
  public Task(
    String name,
    String description,
  ...
  public String toString() {
    ...
    String info =
                    "Domain.Task Name:          " + getName() + '\n' +
                    "Description:        " + getDescription() + '\n' +
                    "Estimated Duration: " + getEstimatedDuration().toString() + '\n' +
                    "Accepted Deviation: " + getAcceptableDeviation() + '\n' +
                    "Domain.Status:             " + getStatus().toString() + (getStatus() == Status.FINISHED ? (", " + getFinishedStatus()) : "") + "\n\n" +

                    "Replacement Domain.Task:   " + showReplacementTaskName() + '\n' +
                    "Replaces Domain.Task:      " + showReplacesTaskName() + "\n\n" +

                    "Start Domain.Time:         " + showStartTime() + '\n' +
                    "End Domain.Time:           " + showEndTime() + "\n\n" +

                    "Domain.User:               " + user.getUsername() + "\n\n";
  ...
  /**
   * @return Domain.Task that replaces this task
   */
  ...
  /**
   * @return Domain.Task this task replaces
   */
  ...
  private String showStartTime() {
    if (getTimeSpan() == null) {
      return "Domain.Task has not started yet";
    }
  ...
  private String showEndTime() {
    if (getTimeSpan() == null) {
      return "Domain.Task has not ended yet";
    }
  ...
  private void setEndTime(Time endTime) throws IncorrectTaskStatusException {
    TimeSpan timeSpan = getTimeSpan();
    // als het systeem al Executing is moet er eigenlijk al een starttime zijn en dus een Domain.TimeSpan
    if (timeSpan == null) {
  ...
  /**
   * @return Domain.Status regarding when this task was finished (early, on time or delayed), based on acceptable deviation and duration
   */
   ...
   *
   * @param startTime Domain.Time the task will start
   * @param systemTime Current system time
   * @param currentUser Domain.User currently logged in
   ...
   * @param endTime Domain.Time at which this task should end
   * @param systemTime Current system time
   * @param currentUser Domain.User currently logged in

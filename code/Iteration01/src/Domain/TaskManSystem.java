...
public class TaskManSystem {
   ...
   * @return Domain.Project corresponding to the given project name, null if no such project exists
   */
   ...
   * @param dueTime Domain.Time at which the project is due
   ...
   * @param projectName Name of the project to create
   * @param projectDescription Description of the project to create
   * @param startTime Domain.Time at which the project is to start
   * @param dueTime Domain.Time at which the project is due
   * @throws DueBeforeSystemTimeException if the given due time is before system time
   * @throws ProjectNameAlreadyInUseException if the given project name is already in use
   */
   ...
   *
   * @param projectName Domain.Project name of project which to add the created task to
   * @param taskName Domain.Task name of the task to create and add to the project
   * @param description Domain.Task description of the task
   ...
   * @param givenUser Domain.User to assign to the task
   * @throws ProjectNotFoundException if the given project name does not correspond to an existing project
   ...
   * @return Domain.Status of the given task (AVAILABLE, UNAVAILABLE, EXECUTING, FINISHED, FAILED)
   * @throws ProjectNotFoundException if the given project does not correspond to an existing project
   * @throws TaskNotFoundException if the given task does not correspond to an existing task within the given project
   */
   ...
   * @param startTime Domain.Time at which the task should start
   ...
   * @param endTime Domain.Time at which the task should end
   * @param newStatus Domain.Status to change the given task into
   * @param currentUser Domain.User currently logged in
   * @throws ProjectNotFoundException if the given project name does not correspond to an existing project
   * @throws TaskNotFoundException if the given task name does not correspond to an existing task within the given project
   ...
   *
   * @param newTime Domain.Time which to change the system time to

...
public class UpdateTaskUI {
    ...
    public void updateForm(String projectName, String taskName, Status status, int systemHour, int systemMinute) {
        Scanner scanner = new Scanner(System.in);
        switch (status) {
            case AVAILABLE -> {
                System.out.println("Give the start time for the task.");
                System.out.println("Do you want to use system time (" + systemHour + ":" + systemMinute +")? (y/n)");
                ...
                if (answer.equals("y")){
                    ...
                    while (true) {
                        try {
                            ...
                            System.out.println("Given start hour is not an integer or '.', please try again");
                    ...
                    while (true) {
                        try {
                            ...
                            System.out.println("Given start minute is not an integer or '.', please try again");
                ...
                if (answer.equals("y")){
                    ...
                    while (true) {
                        try {
                            ...
                            System.out.println("Given end hour is not an integer or '.', please try again");
                    ...
                    while (true) {
                        try {
                            ...
                            System.out.println("Given end minute is not an integer or '.', please try again");

...
public class CreateProjectUI {
  ...
  public void createProjectForm() throws IncorrectPermissionException {
    ...
    while(true) {
      ...
      System.out.println("Domain.Project Name: ");
      String projectName = scanner.nextLine();
      if (projectName.equals("BACK")) {
        System.out.println("Domain.Project creation cancelled");
        return;
      }

      System.out.println("Domain.Project Description: ");
      ...
      System.out.println("Domain.Project due hour: ");
      ...
      System.out.println("Domain.Project due minute: ");
      ...
      try {
        ...
        System.out.println("Domain.Project with name " + projectName + " created!");
        return;

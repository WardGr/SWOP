  ...
  public void chooseUpdateTask() throws IncorrectPermissionException {
    ...
    while(true) {
      ...
      availableTasks.forEach(
              (project, tasks) -> tasks.forEach( (task) -> System.out.println("Domain.Project: " + project + " --- " + task))
      );
      System.out.println();
      ...
      switch (status) {
        case AVAILABLE -> {
          ...
          try{
            ...
            System.out.println("Domain.Task " + taskName + " successfully updated");
            return;
        ...
        default -> {
          System.out.println("ERROR: Domain.Task status doesn't allow an update.");
          return;
        }
      }
    }

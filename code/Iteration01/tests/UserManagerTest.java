...
public class UserManagerTest {
    ...
    public void UserManTest() throws LoginException, UserNotFoundException {
        ...
        User olav = new User("OlavBl", "toilet753", Role.DEVELOPER);
        User sam = new User("SamHa", "pintje452", Role.DEVELOPER);
        ...
        assertEquals(sam.getUsername(), userManager.getUser("SamHa", "pintje452").getUsername());
        assertEquals(sam.getPassword(), userManager.getUser("SamHa", "pintje452").getPassword());
        assertEquals(sam.getRole(), userManager.getUser("SamHa", "pintje452").getRole());
        assertEquals(olav.getUsername(), userManager.getUser(("OlavBl"), "toilet753").getUsername());
        assertEquals(olav.getPassword(), userManager.getUser("OlavBl", "toilet753").getPassword());
        assertEquals(olav.getRole(), userManager.getUser("OlavBl", "toilet753").getRole());

...
public class StartTaskController {
     ...
     */
    public void startTask(String projectName, String taskName, Role role, boolean confirmation) throws IncorrectPermissionException, ProjectNotFoundException, TaskNotFoundException, IncorrectTaskStatusException, IncorrectRoleException, UserAlreadyAssignedToTaskException, UnconfirmedActionException {
        ...
        if (startTaskNeedsConfirmation() && !confirmation){
            throw new UnconfirmedActionException("Starting of the task needs confirmation and isn't confirmed");
        }

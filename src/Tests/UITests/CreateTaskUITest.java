...
import UserInterface.TaskUIs.CreateTaskUI;
...
public class CreateTaskUITest {
    ...
    private CreateTaskController managerController;
    private CreateTaskController developerController;
    private CreateTaskUI managerUI;
    private CreateTaskUI developerUI;
    ...
    public void setUp() throws InvalidTimeException, ProjectNameAlreadyInUseException, DueBeforeSystemTimeException, ProjectNotFoundException, TaskNameAlreadyInUseException, TaskNotFoundException, IllegalTaskRolesException, ProjectNotOngoingException, IncorrectTaskStatusException, LoopDependencyGraphException {
        ...
        managerController = new CreateTaskController(managerSessionProxy, taskManSystem, commandManager);
        developerController = new CreateTaskController(developerSessionProxy, taskManSystem, commandManager);

        developerUI = new CreateTaskUI(developerController);
        managerUI = new CreateTaskUI(managerController);

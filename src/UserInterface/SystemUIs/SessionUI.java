...
/**
 * Handles user input for the login and logout use-cases, requests necessary domain-level information from the Application.Controllers.ProjectControllers.SystemControllers.SessionController
 */
